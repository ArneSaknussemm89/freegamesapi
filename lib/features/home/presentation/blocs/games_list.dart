...
import 'package:freegamesexample/features/home/data/repositories/games.dart';
...
final gamesListBlocProvider = BlocProvider.autoDispose<GamesListBloc, GamesListState>((ref) {
...
class GamesListBloc extends GraphBloc<GamesListEvent, GamesListState> {
  ...
  Future<void> refresh() async {
    return add(const GamesListRetry());
  }
}
