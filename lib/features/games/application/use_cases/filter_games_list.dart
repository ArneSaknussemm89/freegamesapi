...
class FilterGamesListUseCase extends UseCaseWithParams<Object?, List<GameVM>,
    FilterGamesListUseCaseParams> {
  const FilterGamesListUseCase();

  @override
  UseCaseResult<Object?, List<GameVM>> execute(
      FilterGamesListUseCaseParams params) {
